...
<<echo=FALSE>>=
  ...
  pop_thresh <- !purrr::is.empty(pop_exceeded_time)
@
  ...
  \item Pop.{} threshold first exceeded: \Sexpr{pop_exceeded_time}
  \item Spraying necessary: \Sexpr{pop_thresh & pop_exceeded_time < 22}
