...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        $[K] = L^{1} M^{0.50} \Theta^{-1.50} T^{-0.50}$.
        ...
        \SI{13.78}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{54.17}{mm}. The density of vegetation is
        estimated to be about $\SI{6.72}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{24.59}{\celsius.day}$. Finally, the 2017 fire season
...
Formula: $S = 7547.5133105 Q^{0} L^{-2} \delta^{-0.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{7.5475133\times 10^{9}} Q^{0} L^{-2} \delta^{-0.5} X^{1.5}$
