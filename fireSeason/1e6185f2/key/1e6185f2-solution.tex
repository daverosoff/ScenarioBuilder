...
Formula: $S = \ensuremath{3.1476578\times 10^{4}} Q^{-1.5} L^{-2} \delta^{-0.5} X^{2.5}$

Formula if convert to meters: $S = \ensuremath{3.1476578\times 10^{10}} Q^{-1.5} L^{-2} \delta^{-0.5} X^{2.5}$
