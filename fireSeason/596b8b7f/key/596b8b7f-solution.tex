...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{18.92}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{61.53}{mm}. The density of vegetation is
        estimated to be about $\SI{6.71}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{24.06}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{134}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{1.8314112\times 10^{9}} Q^{-1.5} P^{-4} \delta^{-1} X^{2}$

Formula if convert to meters: $S = \ensuremath{1.8314112\times 10^{21}} Q^{-1.5} P^{-4} \delta^{-1} X^{2}$
