...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{18.52}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{63.05}{mm}. The density of vegetation is
        estimated to be about $\SI{10.90}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{26.50}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{119}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{1.247165\times 10^{9}} Q^{-2} P^{-4} \delta^{-1.5} X^{3}$

Formula if convert to meters: $S = \ensuremath{1.247165\times 10^{21}} Q^{-2} P^{-4} \delta^{-1.5} X^{3}$
