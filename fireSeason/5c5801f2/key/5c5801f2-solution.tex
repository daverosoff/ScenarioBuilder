...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{13.84}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{58.58}{mm}. The density of vegetation is
        estimated to be about $\SI{11.93}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{22.04}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{102}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{1.4604175\times 10^{11}} Q^{-1} L^{-4} \delta^{-1.5} X^{0.5}$

Formula if convert to meters: $S = \ensuremath{1.4604175\times 10^{23}} Q^{-1} L^{-4} \delta^{-1.5} X^{0.5}$
