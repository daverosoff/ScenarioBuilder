...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{18.37}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{66.81}{mm}. The density of vegetation is
        estimated to be about $\SI{8.29}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{28.95}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{122}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{7.8417029\times 10^{6}} Q^{-2} P^{-3} \delta^{-0.5} X^{2.5}$

Formula if convert to meters: $S = \ensuremath{7.8417029\times 10^{15}} Q^{-2} P^{-3} \delta^{-0.5} X^{2.5}$
