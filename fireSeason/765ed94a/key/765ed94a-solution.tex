...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{17.83}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{62.38}{mm}. The density of vegetation is
        estimated to be about $\SI{10.35}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{36.61}{\celsius.day}$. Finally, the 2017 fire season
...
Formula: $S = \ensuremath{3.0885171\times 10^{11}} Q^{-1} L^{-5} \delta^{-1.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{3.0885171\times 10^{26}} Q^{-1} L^{-5} \delta^{-1.5} X^{1.5}$
