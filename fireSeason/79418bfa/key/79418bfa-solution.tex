...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{18.61}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{55.56}{mm}. The density of vegetation is
        estimated to be about $\SI{6.46}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{32.51}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{112}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{2.9854408\times 10^{9}} Q^{-1.5} P^{-4} \delta^{-1} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{2.9854408\times 10^{21}} Q^{-1.5} P^{-4} \delta^{-1} X^{1.5}$
