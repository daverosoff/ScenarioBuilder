...
Formula: $S = \ensuremath{5.0475984\times 10^{9}} Q^{-1} P^{-4} \delta^{-1.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{5.0475984\times 10^{21}} Q^{-1} P^{-4} \delta^{-1.5} X^{1.5}$
