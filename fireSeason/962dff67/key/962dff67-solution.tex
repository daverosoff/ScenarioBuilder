...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        $[K] = L^{1} M^{0.50} \Theta^{-0.50} T^{-0.50}$.
        ...
        \SI{12.28}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{63.52}{mm}. The density of vegetation is
        estimated to be about $\SI{12.14}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{23.68}{\celsius.day}$. Finally, the 2017 fire season
...
Formula: $S = \ensuremath{2.1869477\times 10^{5}} Q^{-1} L^{-2} \delta^{-0.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{2.1869477\times 10^{11}} Q^{-1} L^{-2} \delta^{-0.5} X^{1.5}$
