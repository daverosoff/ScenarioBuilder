...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{19.02}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{65.62}{mm}. The density of vegetation is
        estimated to be about $\SI{11.16}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{35.40}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{123}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{1.2912182\times 10^{6}} Q^{-1.5} L^{-3} \delta^{-0.5} X^{2.5}$

Formula if convert to meters: $S = \ensuremath{1.2912182\times 10^{15}} Q^{-1.5} L^{-3} \delta^{-0.5} X^{2.5}$
