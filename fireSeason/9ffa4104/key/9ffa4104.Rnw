...
Formula: $S = \Sexpr{K.no.convert} Q^{\Sexpr{a}} L^{\Sexpr{b}} \delta^{\Sexpr{c}} X^{\Sexpr{d}}$

Formula if convert to meters: $S = \Sexpr{K.meters} Q^{\Sexpr{a}} L^{\Sexpr{b}} \delta^{\Sexpr{c}} X^{\Sexpr{d}}$
