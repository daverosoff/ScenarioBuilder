...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{12.37}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{54.80}{mm}. The density of vegetation is
        estimated to be about $\SI{6.15}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{27.46}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{101}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{2.6480783\times 10^{9}} Q^{0} L^{-4} \delta^{-1.5} X^{0.5}$

Formula if convert to meters: $S = \ensuremath{2.6480783\times 10^{21}} Q^{0} L^{-4} \delta^{-1.5} X^{0.5}$
