...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        $[K] = L^{2} M^{0.50} \Theta^{-1.50} T^{-0.50}$.
        ...
        \SI{13.46}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{65.59}{mm}. The density of vegetation is
        estimated to be about $\SI{7.08}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{23.19}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{108}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{7.25841\times 10^{5}} Q^{0} L^{-3} \delta^{-0.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{7.25841\times 10^{14}} Q^{0} L^{-3} \delta^{-0.5} X^{1.5}$
