...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{19.81}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{60.45}{mm}. The density of vegetation is
        estimated to be about $\SI{12.41}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{31.49}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{143}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{2.5153629\times 10^{12}} Q^{-1.5} L^{-5} \delta^{-1.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{2.5153629\times 10^{27}} Q^{-1.5} L^{-5} \delta^{-1.5} X^{1.5}$
