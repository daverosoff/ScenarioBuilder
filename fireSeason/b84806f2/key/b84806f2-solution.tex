...
Formula: $S = \ensuremath{7.9571241\times 10^{12}} Q^{-1} L^{-5} \delta^{-1.5} X^{0.5}$

Formula if convert to meters: $S = \ensuremath{7.9571241\times 10^{27}} Q^{-1} L^{-5} \delta^{-1.5} X^{0.5}$
