...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{18.10}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{59.77}{mm}. The density of vegetation is
        estimated to be about $\SI{7.58}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{35.92}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{144}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{3.8269451\times 10^{11}} Q^{0} L^{-5} \delta^{-1.5} X^{0.5}$

Formula if convert to meters: $S = \ensuremath{3.8269451\times 10^{26}} Q^{0} L^{-5} \delta^{-1.5} X^{0.5}$
