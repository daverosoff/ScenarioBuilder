...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{17.88}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{56.53}{mm}. The density of vegetation is
        estimated to be about $\SI{12.96}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{30.90}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{148}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{1.1603412\times 10^{8}} Q^{-2} L^{-3} \delta^{-1} X^{2}$

Formula if convert to meters: $S = \ensuremath{1.1603412\times 10^{17}} Q^{-2} L^{-3} \delta^{-1} X^{2}$
