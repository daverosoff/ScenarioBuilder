...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{14.97}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{60.50}{mm}. The density of vegetation is
        estimated to be about $\SI{8.60}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{35.23}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{104}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{5.4794002\times 10^{7}} Q^{-1.5} P^{-3} \delta^{-1} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{5.4794002\times 10^{16}} Q^{-1.5} P^{-3} \delta^{-1} X^{1.5}$
