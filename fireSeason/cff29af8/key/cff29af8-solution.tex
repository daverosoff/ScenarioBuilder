...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{15.55}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{62.35}{mm}. The density of vegetation is
        estimated to be about $\SI{9.21}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{32.70}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{113}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{8.3380936\times 10^{9}} Q^{0} L^{-4} \delta^{-1.5} X^{0.5}$

Formula if convert to meters: $S = \ensuremath{8.3380936\times 10^{21}} Q^{0} L^{-4} \delta^{-1.5} X^{0.5}$
