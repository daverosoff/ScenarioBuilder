...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{15.17}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{54.49}{mm}. The density of vegetation is
        estimated to be about $\SI{9.01}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{32.03}{\celsius.day}$. Finally, the 2017 fire season
...
Formula: $S = \ensuremath{3.7786604\times 10^{6}} Q^{-1} L^{-3} \delta^{-0.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{3.7786604\times 10^{15}} Q^{-1} L^{-3} \delta^{-0.5} X^{1.5}$
