...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{16.93}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{56.55}{mm}. The density of vegetation is
        estimated to be about $\SI{12.05}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{37.43}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{138}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{7.0405809\times 10^{5}} Q^{-1.5} L^{-3} \delta^{-0.5} X^{2.5}$

Formula if convert to meters: $S = \ensuremath{7.0405809\times 10^{14}} Q^{-1.5} L^{-3} \delta^{-0.5} X^{2.5}$
