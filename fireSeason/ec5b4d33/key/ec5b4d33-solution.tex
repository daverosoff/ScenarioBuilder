...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        $[K] = L^{2} M^{0.50} \Theta^{-0.50} T^{-0.50}$.
        ...
        \SI{13.14}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{65.33}{mm}. The density of vegetation is
        estimated to be about $\SI{6.29}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{34.91}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{152}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{6.7730518\times 10^{6}} Q^{-1} P^{-3} \delta^{-0.5} X^{1.5}$

Formula if convert to meters: $S = \ensuremath{6.7730518\times 10^{15}} Q^{-1} P^{-3} \delta^{-0.5} X^{1.5}$
