...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        \SI{15.15}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{57.07}{mm}. The density of vegetation is
        estimated to be about $\SI{10.97}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{22.55}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{111}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{1.1015045\times 10^{12}} Q^{-2} L^{-5} \delta^{-1.5} X^{2}$

Formula if convert to meters: $S = \ensuremath{1.1015045\times 10^{27}} Q^{-2} L^{-5} \delta^{-1.5} X^{2}$
