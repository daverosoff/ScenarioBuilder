...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        $[K] = L^{1} M^{0.50} \Theta^{-1.50} T^{-1.50}$.
        ...
        \SI{17.60}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{62.55}{mm}. The density of vegetation is
        estimated to be about $\SI{7.80}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{26.65}{\celsius.day}$. Finally, the 2017 fire season
...
Formula: $S = 6240.9843308 Q^{-1} L^{-2} \delta^{-0.5} X^{2.5}$

Formula if convert to meters: $S = \ensuremath{6.2409843\times 10^{9}} Q^{-1} L^{-2} \delta^{-0.5} X^{2.5}$
