...
% \vspace{-2.8ex}
    ...
    \begin{compactitem}
        ...
        $[K] = L^{2} M^{0.50} \Theta^{-0.50} T^{-1.50}$.
        ...
        \SI{15.04}{\celsius}. The January--June average
        accumulated precipitation in 2017 was
        \SI{61.15}{mm}. The density of vegetation is
        estimated to be about $\SI{9.32}{kg/m^2}$ in this region.
        The May--June average cumulative temperature excess for 2017 was
        $\SI{32.62}{\celsius.day}$. Finally, the 2017 fire season
        lasted $\num{150}$ days. You will base your model on these
        data.
...
Formula: $S = \ensuremath{3.8964209\times 10^{6}} Q^{-2} L^{-3} \delta^{-0.5} X^{2.5}$

Formula if convert to meters: $S = \ensuremath{3.8964209\times 10^{15}} Q^{-2} L^{-3} \delta^{-0.5} X^{2.5}$
